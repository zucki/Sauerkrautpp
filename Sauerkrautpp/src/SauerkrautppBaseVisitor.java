...
public class SauerkrautppBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SauerkrautppVisitor<T> {
	...
	@Override public T visitKleinergleich(SauerkrautppParser.KleinergleichContext ctx) { return visitChildren(ctx); }

	@Override public T visitUnd(SauerkrautppParser.UndContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitArg(SauerkrautppParser.ArgContext ctx) { return visitChildren(ctx); }

	@Override public T visitEmptyArglist(SauerkrautppParser.EmptyArglistContext ctx) { return visitChildren(ctx); }

	@Override public T visitElse_(SauerkrautppParser.Else_Context ctx) { return visitChildren(ctx); }

	@Override public T visitPrint_func(SauerkrautppParser.Print_funcContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitOder(SauerkrautppParser.OderContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitInitialisierung(SauerkrautppParser.InitialisierungContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitStatement(SauerkrautppParser.StatementContext ctx) { return visitChildren(ctx); }

	@Override public T visitArgument(SauerkrautppParser.ArgumentContext ctx) { return visitChildren(ctx); }
